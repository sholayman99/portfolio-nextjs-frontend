    ...
    return (
        <div className="p-6 rounded-xl backdrop-blur-sm border border-gray-700/50 shadow-xl">
            <h2 className="text-2xl font-mono font-semibold text-white mb-6 flex items-center tracking-tight">
                <FiMapPin className="text-accent mr-3 text-2xl" />
                Personal Details
            </h2>
            <ul className="space-y-3">
                <motion.li
                    className="flex items-center bg-accent/10 border border-accent/30 hover:bg-accent/20 p-3 rounded-lg"
                ...
                <motion.li
                    className="flex items-center bg-accent/10 border border-accent/30 hover:bg-accent/20 p-3 rounded-lg  transition-colors"
                    initial={{ opacity: 0, y: 10 }}
                    whileInView={{ opacity: 1, y: 0 }}
